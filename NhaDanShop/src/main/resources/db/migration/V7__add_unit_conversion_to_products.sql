...
ALTER TABLE products ADD import_unit NVARCHAR(20) NULL;

-- Đơn vị bán lẻ (bịch, gói, chai...)
ALTER TABLE products ADD sell_unit NVARCHAR(20) NULL;
...
ALTER TABLE products ADD conversion_note NVARCHAR(100) NULL;
