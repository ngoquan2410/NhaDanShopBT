                          ...
                          <div className="flex items-start justify-between gap-2">
                            <div className="flex items-center gap-2.5 min-w-0">
                              ...
                              <div className="min-w-0">
                                ...
                                <p className="text-xs text-muted-foreground truncate">{product.code} · {product.categoryName}</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-1 shrink-0">
                              ...
                              <RowActions
                                  actions={[
                                    { label: "Xem chi tiết", icon: <Eye className="h-3.5 w-3.5" />, onClick: () => navigate(`/admin/products/${product.id}`) },
                                    { label: "Sửa sản phẩm", icon: <Pencil className="h-3.5 w-3.5" />, onClick: () => navigate(`/admin/products/${product.id}`) },
                                    { label: product.active ? "Ngưng bán" : "Kích hoạt", icon: <Power className="h-3.5 w-3.5" />, onClick: () => void handleToggleActive(product) },
                                    { separatorBefore: true, label: "Xóa sản phẩm", icon: <Trash2 className="h-3.5 w-3.5" />, danger: true, onClick: () => setConfirmDelete(product) },
                                  ]}
                              />
                            </div>
                          </div>
