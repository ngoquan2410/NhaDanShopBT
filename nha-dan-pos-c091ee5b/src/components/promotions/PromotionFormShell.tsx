...
export function PromotionFormShell({ promo, onClose, onSave }: Props) {
  ...
  return (
      <div className="fixed inset-0 z-50 flex justify-end">
        ...
        <div className="relative w-full sm:max-w-xl bg-card sm:border-l shadow-xl flex flex-col animate-slide-in-right h-full">
          ...
          <div className="p-3 sm:p-4 border-t flex gap-2 bg-card shadow-[0_-4px_12px_-8px_rgba(0,0,0,0.15)]">
